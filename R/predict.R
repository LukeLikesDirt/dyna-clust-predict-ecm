...
# sibling dyna-clust-predict-am project), so the previous 2000 MiB cap forced
# silent fallback to sequential processing. ECM's full-ITS datasets are larger
# still, so this matters even more here.
